...
def delayhetsampling(
    ...
    ###########################################################
    # Estimate covariance matrices A_i
    ###########################################################
    ...
    def estimate_covariance(model, client):
        ...
        cov = (Fmat.T @ Fmat) / max(Fmat.shape[0]-1, 1)
    ...
    ###########################################################
    # Optimize sampling probabilities
    ###########################################################
    ...
    while current_time < MAX_TIME:
        ...
        #######################################################
        # Sample K clients using optimized distribution
        #######################################################
        ...
        if current_time in arrivals:
            ...
            for (_, delta, _), alpha in zip(updates, weights):
