...
def create_non_iid_clients(
    ...
    for k in range(K):
        chosen_labels = torch.randperm(C)[:classes_per_client]
...
plt.title("Non IID MNIST (10-class): Test Accuracy vs Wall-clock Time")
plt.legend()
plt.grid(True)
plt.tight_layout()
plt.savefig("plots_mnist_noniid_log_regression_cpu/Test_accuracy.png",dpi=300,bbox_inches="tight")
#plt.show()
...
plt.title("Non IID MNIST (10-class): Training Accuracy vs Wall-clock Time")
plt.legend()
plt.grid(True)
plt.tight_layout()
plt.savefig("plots_mnist_noniid_log_regression_cpu/Training_accuracy.png",dpi=300,bbox_inches="tight")
#plt.show()
